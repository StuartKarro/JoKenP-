...
if opcao == 1: # Player contra player
    while continua == 1:
        ...
        if pessoa1 == pessoa2:
            ...
            print("Vitória do primeiro jogador")
            vitoria1 = vitoria1 + 1
        elif pessoa2 == 3 and pessoa1 == 1:# --------------------------- TESOURA - PEDRA
            print("Vitória do primeiro jogador")
            vitoria1 = vitoria1 + 1

        continua = int(input("Deseja continuar a jogar?\n1- sim\n2- não\n"))

elif opcao == 2: # Player contra computador
    while continua == 1:
        pessoa1 = int(input("1- Pedra\n2- Papel\n3- Tesoura\n"))
        ...
        if pessoa1 == pessoa2:
            ...
            print("Vitória do primeiro jogador")
            vitoria1 = vitoria1 + 1
        print('\nO computador jogou:', pessoa2)
        continua = int(input("Deseja continuar a jogar?\n1- sim\n2- não\n"))


elif opcao == 3: # Computador contra computador
    while continua == 1:
        ...
        if pessoa1 == pessoa2:
            ...
            print("Vitória do computador 1")
            vitoria1 = vitoria1 + 1
        print('\nO computador 1 jogou:', pessoa1)
        print('\nO computador 2 jogou:', pessoa2)
        continua = int(input("Deseja continuar a jogar?\n1- sim\n2- não\n"))
